...
class AlertMesage: NSObject {
    public class func show(_ theme: Theme, title: String? = nil, message: String?, duration: Int  = 2) {
        ...
        switch theme {
        case .info:
            view.configureTheme(backgroundColor: UIColor.Color.lightblue, foregroundColor: .white, iconImage: iconStyle.image(theme: .info), iconText: nil)
        ...
        case .warning:
            ...
            view.iconImageView?.image = view.iconImageView?.image!.withRenderingMode(.alwaysTemplate)
            view.iconImageView?.tintColor = UIColor.Color.red
        ...
        // Set Font
        view.titleLabel?.font = UIFont.systemFont(ofSize: 14.0, weight: .regular)

        view.bodyLabel?.font = UIFont.systemFont(ofSize: 14.0, weight: .regular)
        ...
        config.duration = .seconds(seconds: Double(duration))
    ...
    public class func showInternetNotConnected(message: String = "Internet Connection Lost") {
        ...
        view.configureTheme(backgroundColor: UIColor.Color.green,
